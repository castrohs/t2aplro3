...
public class Grafo2 {
    ...
    public String largura(int nodo) {
        ...
        // visitar nodo
        //
        // enquanto a F n�o est� vazia
        // remover de F um nodo n
        // para cada adjacente de n
        // se adjacente n�o est� visitado
        // visitar adjacente
    ...
    public ArrayList<Integer> getFontes() {
        // para cada nodo
        //	verificar se o nodo n�o tem entrada
    ...
    public ArrayList<Integer> getSumidouros() {
        //TODO: 
        // para cada nodo
        //	verificar se o nodo n�o tem sa�da
        ArrayList<Integer> resultado = new ArrayList<Integer>();
        int saidas;
        for (int i = 1; i < max; i++) {
            saidas = 0;
    ...
    public boolean isRede() {
        ...
        // somente um sumidouro e � conexo a partir da fonte
